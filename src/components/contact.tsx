...
const Contact = () => {
  return (
    ...
    >
      ...
      {/* ✅ Footer with Beautiful Social Buttons */}
      <footer className="mt-20 border-t border-gray-300 pt-10 pb-6 text-center">
        <div className="flex flex-wrap justify-center gap-6 sm:gap-8 mb-6">
          ...
          <a
            ...
            className="flex items-center gap-3 bg-white border border-[#25D366] text-[#25D366] px-6 py-3 rounded-full shadow-sm hover:bg-[#25D366] hover:text-white transition-all duration-300"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 bg-white border border-[#076496] text-[#076496] px-6 py-3 rounded-full shadow-sm hover:bg-[#076496] hover:text-white transition-all duration-300"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 bg-white border border-[#171515] text-[#171515] px-6 py-3 rounded-full shadow-sm hover:bg-[#171515] hover:text-white transition-all duration-300"
          >
        ...
        <p className="text-sm text-[#4f5242]">
          &copy; {new Date().getFullYear()} Anoushey Chandio. All rights
          reserved.
        </p>
      </footer>
    </section>
